...
/**
 * Created by anubhav on 2/29/2016.
 */
public class PrescriptionModel {
    ...
    String destroyed_quantity;
    String carried_forward_quantity;
    int wasted_quantity;
    ...
    public String getDestroyed_quantity() {
        return destroyed_quantity;
    }

    public void setDestroyed_quantity(String destroyed_quantity) {
        this.destroyed_quantity = destroyed_quantity;
    }

    public String getCarried_forward_quantity() {
        return carried_forward_quantity;
    }

    public void setCarried_forward_quantity(String carried_forward_quantity) {
   ...
   /* public String getTime_slot_doses_color() {
    ...
    //---------------------------------------------16-03-16-----------------------------------------------------------//
    String m1time_slot_doses_color;
    String m1time_slot_doses_dose;
    String m1time_slot_doses_id;
    String m1time_slot_doses_show_as;
    String m1time_slot_doses_slot_time;

    String m2time_slot_doses_color;
    String m2time_slot_doses_dose;
    String m2time_slot_doses_id;
    String m2time_slot_doses_show_as;
    String m2time_slot_doses_slot_time;

    String luntime_slot_doses_color;
    String luntime_slot_doses_dose;
    String luntime_slot_doses_id;
    String luntime_slot_doses_show_as;
    String luntime_slot_doses_slot_time;

    String dintime_slot_doses_color;
    String dintime_slot_doses_dose;
    String dintime_slot_doses_id;
    String dintime_slot_doses_show_as;
    String dintime_slot_doses_slot_time;

    String ngttime_slot_doses_color;
    String ngttime_slot_doses_dose;
    String ngttime_slot_doses_id;
    String ngttime_slot_doses_show_as;
    String ngttime_slot_doses_slot_time;

    public String getM1time_slot_doses_color() {
        return m1time_slot_doses_color;
    }

    public void setM1time_slot_doses_color(String m1time_slot_doses_color) {
        this.m1time_slot_doses_color = m1time_slot_doses_color;
    }

    public String getM1time_slot_doses_dose() {
        return m1time_slot_doses_dose;
    }

    public void setM1time_slot_doses_dose(String m1time_slot_doses_dose) {
        this.m1time_slot_doses_dose = m1time_slot_doses_dose;
    }

    public String getM1time_slot_doses_id() {
        return m1time_slot_doses_id;
    }

    public void setM1time_slot_doses_id(String m1time_slot_doses_id) {
        this.m1time_slot_doses_id = m1time_slot_doses_id;
    }

    public String getM1time_slot_doses_show_as() {
        return m1time_slot_doses_show_as;
    }

    public void setM1time_slot_doses_show_as(String m1time_slot_doses_show_as) {
        this.m1time_slot_doses_show_as = m1time_slot_doses_show_as;
    }

    public String getM1time_slot_doses_slot_time() {
        return m1time_slot_doses_slot_time;
    }

    public void setM1time_slot_doses_slot_time(String m1time_slot_doses_slot_time) {
        this.m1time_slot_doses_slot_time = m1time_slot_doses_slot_time;
    }

    public String getM2time_slot_doses_color() {
        return m2time_slot_doses_color;
    }

    public void setM2time_slot_doses_color(String m2time_slot_doses_color) {
        this.m2time_slot_doses_color = m2time_slot_doses_color;
    }

    public String getM2time_slot_doses_dose() {
        return m2time_slot_doses_dose;
    }

    public void setM2time_slot_doses_dose(String m2time_slot_doses_dose) {
        this.m2time_slot_doses_dose = m2time_slot_doses_dose;
    }

    public String getM2time_slot_doses_id() {
        return m2time_slot_doses_id;
    }

    public void setM2time_slot_doses_id(String m2time_slot_doses_id) {
        this.m2time_slot_doses_id = m2time_slot_doses_id;
    }

    public String getM2time_slot_doses_show_as() {
        return m2time_slot_doses_show_as;
    }

    public void setM2time_slot_doses_show_as(String m2time_slot_doses_show_as) {
        this.m2time_slot_doses_show_as = m2time_slot_doses_show_as;
    }

    public String getM2time_slot_doses_slot_time() {
        return m2time_slot_doses_slot_time;
    }

    public void setM2time_slot_doses_slot_time(String m2time_slot_doses_slot_time) {
        this.m2time_slot_doses_slot_time = m2time_slot_doses_slot_time;
    }

    public String getLuntime_slot_doses_color() {
        return luntime_slot_doses_color;
    }

    public void setLuntime_slot_doses_color(String luntime_slot_doses_color) {
        this.luntime_slot_doses_color = luntime_slot_doses_color;
    }

    public String getLuntime_slot_doses_dose() {
        return luntime_slot_doses_dose;
    }

    public void setLuntime_slot_doses_dose(String luntime_slot_doses_dose) {
        this.luntime_slot_doses_dose = luntime_slot_doses_dose;
    }

    public String getLuntime_slot_doses_id() {
        return luntime_slot_doses_id;
    }

    public void setLuntime_slot_doses_id(String luntime_slot_doses_id) {
        this.luntime_slot_doses_id = luntime_slot_doses_id;
    }

    public String getLuntime_slot_doses_show_as() {
        return luntime_slot_doses_show_as;
    }

    public void setLuntime_slot_doses_show_as(String luntime_slot_doses_show_as) {
        this.luntime_slot_doses_show_as = luntime_slot_doses_show_as;
    }

    public String getLuntime_slot_doses_slot_time() {
        return luntime_slot_doses_slot_time;
    }

    public void setLuntime_slot_doses_slot_time(String luntime_slot_doses_slot_time) {
        this.luntime_slot_doses_slot_time = luntime_slot_doses_slot_time;
    }

    public String getDintime_slot_doses_color() {
        return dintime_slot_doses_color;
    }

    public void setDintime_slot_doses_color(String dintime_slot_doses_color) {
        this.dintime_slot_doses_color = dintime_slot_doses_color;
    }

    public String getDintime_slot_doses_dose() {
        return dintime_slot_doses_dose;
    }

    public void setDintime_slot_doses_dose(String dintime_slot_doses_dose) {
        this.dintime_slot_doses_dose = dintime_slot_doses_dose;
    }

    public String getDintime_slot_doses_id() {
        return dintime_slot_doses_id;
    }

    public void setDintime_slot_doses_id(String dintime_slot_doses_id) {
        this.dintime_slot_doses_id = dintime_slot_doses_id;
    }

    public String getDintime_slot_doses_show_as() {
        return dintime_slot_doses_show_as;
    }

    public void setDintime_slot_doses_show_as(String dintime_slot_doses_show_as) {
        this.dintime_slot_doses_show_as = dintime_slot_doses_show_as;
    }

    public String getDintime_slot_doses_slot_time() {
        return dintime_slot_doses_slot_time;
    }

    public void setDintime_slot_doses_slot_time(String dintime_slot_doses_slot_time) {
        this.dintime_slot_doses_slot_time = dintime_slot_doses_slot_time;
    }

    public String getNgttime_slot_doses_dose() {
        return ngttime_slot_doses_dose;
    }

    public void setNgttime_slot_doses_dose(String ngttime_slot_doses_dose) {
        this.ngttime_slot_doses_dose = ngttime_slot_doses_dose;
    }

    public String getNgttime_slot_doses_color() {
        return ngttime_slot_doses_color;
    }

    public void setNgttime_slot_doses_color(String ngttime_slot_doses_color) {
        this.ngttime_slot_doses_color = ngttime_slot_doses_color;
    }

    public String getNgttime_slot_doses_id() {
        return ngttime_slot_doses_id;
    }

    public void setNgttime_slot_doses_id(String ngttime_slot_doses_id) {
        this.ngttime_slot_doses_id = ngttime_slot_doses_id;
    }

    public String getNgttime_slot_doses_show_as() {
        return ngttime_slot_doses_show_as;
    }

    public void setNgttime_slot_doses_show_as(String ngttime_slot_doses_show_as) {
        this.ngttime_slot_doses_show_as = ngttime_slot_doses_show_as;
    }

    public String getNgttime_slot_doses_slot_time() {
        return ngttime_slot_doses_slot_time;
    }

    public void setNgttime_slot_doses_slot_time(String ngttime_slot_doses_slot_time) {
        this.ngttime_slot_doses_slot_time = ngttime_slot_doses_slot_time;
    }
}

...
//
//public class PatientDetail_9june extends BaseActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener,
...
//    ArrayList<PRESCRIPTION_COMMON_Model> admin_prescription_modelArrayList;
...
//        jsonParser = new JSONParser(PatientDetail_9june.this);
...
//        admin_prescription_modelArrayList = new ArrayList<PRESCRIPTION_COMMON_Model>();
...
//            imc_met = "this_cycle";
//            Log.e("NetworkAvailablity", "NetworkAvailablity------->" + NetworkAvailablity.chkStatus(PatientDetail_9june.this));
//            if (NetworkAvailablity.chkStatus(PatientDetail_9june.this)) {
//                new getCheckin().execute(imc_met);
//            } else {
//                Log.e("NetworkAvailablity", "offline------->");
//                newchecklist.clear();
//                newchecklist = mydbobj.getallFeedsFromDB(patientId, imc_met);
//                new_checkinAdapter = new New_CheckinAdapter(PatientDetail_9june.this, newchecklist);
...
//            new_homely_List.clear();
//            new_homely_List = mydbobj.gethomelyListfromdb(patientId);
//            new_homely_Adapter = new New_Homely_Adapter(PatientDetail_9june.this, new_homely_List);
...
//                newmedsAdapter = new NewMedsAdapter(PatientDetail_9june.this, newmedsList);
...
//            measureAdapter = new MeasureAdapter(PatientDetail_9june.this, measurearraylist);
...
//            notesadapter = new NotesAdapter(PatientDetail_9june.this, notesarraylist);
...
//            new_return_Adpater = new New_Return_Adpater(PatientDetail_9june.this, new_return_List);
...
//                    App_Constants.showAlertDialog("Alert", "Please save or cancel your changes to continue.", PatientDetail_9june.this, false);
//                } else {
//                    Enable_Checkin_Tab();
//                    llSave.setVisibility(View.VISIBLE);
//                    llAddNote.setVisibility(View.INVISIBLE);
...
////                }
//
//                Toast.makeText(PatientDetail_9june.this, "Audit work in Progress", Toast.LENGTH_SHORT).show();
//
//                break;
//
//            case R.id.llAddNote:
...
//                        if (_IS_SECONDRY_USER_AUTH_REQUIRED) {
//
//                            Toast.makeText(PatientDetail_9june.this, "You are in offline mode, secondary witnesses are not\n" +
...
//            json1.put("created_at", date_utility.get_adminstarated_datetime_ukzone());
...
//            json1.put("medication_id", "9005525");
//            json1.put("outcome", "true");
//            json1.put("patient_id", "164");
//            json1.put("prescription_id", "4503");
//            json1.put("quantity_wasted", "0");
//            json1.put("secondary_user_id", "0");
//            json1.put("seconday_user_fullname", "");
//            json1.put("slot_time", "08:00");
//            json1.put("uid", "740f1073-02fa-4cad-b911-4595060452d7");
//            json1.put("updated_at", "2016-06-08T08:33:33+01:00");
//            json1.put("user_fullname", "Kritika Soni");
//            json1.put("user_id", "99");
//
//            json.put("mar", json1);
//
...
//        FragmentManager fragmentManager = ((FragmentActivity) PatientDetail_9june.this).getSupportFragmentManager();
...
//                Log.e("NetworkAvailablity", "NetworkAvailablity---1---->" + NetworkAvailablity.chkStatus(PatientDetail_9june.this));
//                if (NetworkAvailablity.chkStatus(PatientDetail_9june.this)) {
//                    new getMedsData().execute(imc_met);
//                } else {
//                    newmedsList.clear();
...
//                Log.e("Cycle", "" + imc_met);
//                spnPosition1 = position;
//                Log.e("NetworkAvailablity", "NetworkAvailablity---2---->" + NetworkAvailablity.chkStatus(PatientDetail_9june.this));
//                if (NetworkAvailablity.chkStatus(PatientDetail_9june.this)) {
//                    new getMedsData().execute(imc_met);
//                } else {
//                    newmedsList.clear();
...
//                Log.e("Cycle", "" + imc_met);
//                spnPosition1 = position;
//                Log.e("NetworkAvailablity", "NetworkAvailablity---3---->" + NetworkAvailablity.chkStatus(PatientDetail_9june.this));
//                if (NetworkAvailablity.chkStatus(PatientDetail_9june.this)) {
//                    new getMedsData().execute(imc_met);
//                } else {
//                    newmedsList.clear();
...
//            super.onPreExecute();
////            progDialog.show();
//            dlg = app_constants.dialog(PatientDetail_9june.this, "Loading");
//        }
//
//        @Override
...
//                            medication_string_obj, branded_medication_string_obj, TIME_SLOT_DOSES_array, 0, "false", "this_cycle", patientId);
//
...
//                }
//                mydbobj.addAllFeed(PatientDetail_9june.this, admin_prescription_modelArrayList);
//                getAdmin();
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
...
//                PRESCRIPTION_COMMON_Model adminPrescriptionModel = admin_prescription_modelArrayList.get(i);
...
//
//                                PRESCRIPTION_COMMON_Model adminPrescriptionModel = admin_prescription_modelArrayList.get(x);
//
...
//                            returned_quantity, destroyed_quantity, carried_forward_quantity, wasted_quantity,
//                            administered_quantity, audited_quantity, patient_absent_today, is_controlled, pil_url,
//                            medication_string_obj, branded_medication_string_obj, TIME_SLOT_DOSES_array, 0, "false", "return", patientId);
...
//                    new_return_Adpater = new New_Return_Adpater(PatientDetail_9june.this, new_return_List);
//                    mylist.setAdapter(new_return_Adpater);
//                    mydbobj.addAllFeed(PatientDetail_9june.this, new_return_List);
//                }
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
...
//                    @Override
//                    public void run() {
//                        App_Constants.showAlertDialog("Alert", "No peer certificate", PatientDetail_9june.this, false);
//                    }
//                });
...
//
//            }
//            mydbobj.addAllFeed(PatientDetail_9june.this, newchecklist);
//            new_checkinAdapter = new New_CheckinAdapter(PatientDetail_9june.this, newchecklist);
//            mylist.setAdapter(new_checkinAdapter);
//
//        } catch (Exception e) {
...
//
//                if (tvmeds.isSelected()) {
//                    mydbobj.addAllFeed(PatientDetail_9june.this, newmedsList);
//                    newmedsAdapter = new NewMedsAdapter(PatientDetail_9june.this, newmedsList);
//                    mylist.setAdapter(newmedsAdapter);
//
//                }
...
//
//        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(PatientDetail_9june.this);
//        // set title
...
//                }
//
//                mydbobj.insertNotesData(bsSiteList, "online", "General");
//
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
...
//                } else {
//                    Enable_save_and_cancel_button();
//                    App_Constants.showAlertDialog("Authentication failed", "The credentials you entered could not be authenticated.", PatientDetail_9june.this, false);
//                }
//
//            } catch (Exception e) {
//                Enable_save_and_cancel_button();
...
//        AlertDialog.Builder alertDialogBuilder2 = new AlertDialog.Builder(PatientDetail_9june.this);
//        // set title

package com.syscraft.caremeds.ui;
...
public class DropdownSpinner extends Button implements OnClickListener,
     ...
     *
     * @param color - color code in integer
     */
     ...
     *
     * @param item - String add in spinner
     */
     ...
     *
     * @param item  - String add in spinner
     * @param resId - image (ResId) add in spinner
     */
     ...
     * required equal.
     *
     * @param arr - array of string which is set in spinner
     * @param ico - array of image which is set in spinner
     * @throws SizeNotMatchException - throw exception if string array & image array size not
     *                               match or equal
     */

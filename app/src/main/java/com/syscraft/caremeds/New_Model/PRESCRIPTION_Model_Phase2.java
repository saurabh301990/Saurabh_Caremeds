...
public class PRESCRIPTION_Model_Phase2 {
    ...
    String irregular_grid;
    public String getIrregular_grid_array() {
        return irregular_grid_array;
    }
    public String getEnd_date() {
        return end_date;
    }
    String irregular_grid_array;
    String last_admin;
...
//    String TIME_SLOT_DOSES_array;
    ...
    ArrayList<Today_Mars_Mar_Bean_Phase2> Today_Mars_Mar_objects_list;


    public PRESCRIPTION_Model_Phase2(int id, String prescription_type, String drug_name, String instructions, String indications, String mandatory_instructions, String start_date, String end_date, String is_patch, String patch_location, String non_blistered, String is_controlled, String suppress_non_blister_display, String can_carry_forward, String front_image_url, int dispensed_quantity, int available_quantity, int checked_in_quantity, int brought_forward_quantity, int returned_quantity, int destroyed_quantity, int carried_forward_quantity, int wasted_quantity, int administered_quantity, int audited_quantity, String irregular_grid, String irregular_grid_array, String last_admin, String special_medication_name, String is_special, String prescribed_time_slots_array, int new_checked_in_quantity_toupdate, String isSelected, String checkin_cycle_type, String patient_id, String is_for_admintab) {
        this.id = id;
        ...
        this.irregular_grid = irregular_grid;
        this.irregular_grid_array = irregular_grid_array;
    ...
    public ArrayList<Today_Mars_Mar_Bean_Phase2> getToday_Mars_Mar_objects_list() {
        return Today_Mars_Mar_objects_list;
    }

    public void setToday_Mars_Mar_objects_list(ArrayList<Today_Mars_Mar_Bean_Phase2> today_Mars_Mar_objects_list) {
...
//    public PRESCRIPTION_Model_Phase2(int id,
//                                     String indications,
//                                     String instructions,
//                                     String is_patch,
//                                     String is_special,
